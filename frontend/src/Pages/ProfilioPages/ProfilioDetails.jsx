...
const ProfilioDetails = () => {
  ...
  if (isLoading) return <div className="text-center text-lg p-5">Loading blog...</div>;
  if (isError) return <div className="text-center text-red-600 p-5">Error: {error.message}</div>;
