  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center gap-4 py-6 bg-white">
        <div
          ref={containerRef}
          className="relative w-full max-w-7xl mx-auto overflow-hidden aspect-video rounded-lg shadow-lg select-none touch-none h-[200px] md:h-[400px]"
...
//         <div
//           ref={containerRef}
//           className="relative w-full max-w-7xl mx-auto h-[200px] md:h-[400px] overflow-hidden rounded-lg shadow-lg aspect-video"
//           onMouseMove={handleMove}
//           onMouseUp={() => setIsDragging(false)}
//           onMouseLeave={() => setIsDragging(false)}
//           onTouchMove={(e) => {
